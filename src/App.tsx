    ...
    return (
      <Routes>
        <Route path={"/"} element={<PublicLayout />}>
          ...
          <Route
            path={"/study-abroad/:country/cities/:city"}
            element={<TopUniversities />}
          />
          <Route
            path={"study-abroad/:country/courses/:course"}
            element={<MastersTopCourses />}
          />
          <Route path={"mavencave-ai"} element={<MavenCaveAi />} />
          <Route path={"resources/sop"} element={<SOP />} />
          <Route element={<IeltsBlogLayout />}>
            <Route
              path={"/exams/ielts/overview"}
              element={<IeltsOverviewPage />}
            />
            <Route path={"/exams/ielts/types"} element={<IeltsTypesPage />} />
            <Route
              path={"/resources/books/ielts"}
              element={<IeltsBooksPage />}
            />
            <Route
              path={"/exams/ielts/eligibility"}
              element={<IeltsEligibilityPage />}
            />
            <Route
              path={"/exams/ielts/registration"}
              element={<IeltsRegistrationPage />}
            />
            <Route
              path={"/exams/ielts/results"}
              element={<IeltsResultsPage />}
            />
            <Route path={"/exams/ielts/syllabus"} element={<IeltsSyllabus />} />
            <Route
              path={"/exams/ielts/slot-booking"}
              element={<SlotBookingPage />}
            />
            <Route
              path={"/resources/recommendation-letter/masters"}
              element={<LorMasters />}
            />
            <Route
              path={"/exams/ielts/practice/listening"}
              element={<Listening />}
            />
            <Route
              path={"/exams/ielts/practice/reading"}
              element={<Reading />}
            />
            <Route path={"/exams/ielts/dates"} element={<IeltsExamDate />} />
            <Route path={"/exams/ielts/fees"} element={<IeltsFees />} />
            <Route
              path={"/exams/ielts/centers"}
              element={<IeltsTestCenters />}
            />
            <Route
              path={"/exams/ielts/practice/speaking"}
              element={<Speaking />}
            />
            <Route
              path={"/exams/ielts/practice/writing"}
              element={<Writing />}
            />
            <Route
              path={"/exams/ielts/practice/all-in-one"}
              element={<IeltsPractice />}
            />
            <Route path={"/exams/toefl/overview"} element={<TOEFLPage />} />
            <Route path={"/exams/gre/overview"} element={<GREPage />} />
            <Route
              path={"/exams/sat/eligibility"}
              element={<SATEligibilityPage />}
            />
            <Route
              path={"/exams/sat/registration"}
              element={<SATRegistrationPage />}
            />
            <Route path={"/exams/sat/syllabus"} element={<SATSyllabusPage />} />
            <Route
              path={"/exams/sat/preparation"}
              element={<SATPreparationPage />}
            />
            <Route path={"/exams/pte/overview"} element={<PTEPage />} />
            {/* Duolingo */}
            <Route path={"/exams/duolingo/fees"} element={<DuolingoFees />} />
            <Route
              path={"/exams/duolingo/preparation"}
              element={<DuolingoGuidePage />}
            />
            <Route
              path={"/exams/duolingo/sample"}
              element={<SampleQuestionPage />}
            />
            <Route
              path={"/exams/duolingo/syllabus"}
              element={<DuolingoSyllabusPage />}
            />
            {/* GMAT */}
            <Route
              path={"/exams/gmat/overview"}
              element={<GmatOverviewPage />}
            />
            <Route
              path={"/exams/gmat/preparation"}
              element={<GmatPrepPage />}
            />
            <Route
              path={"/exams/gmat/registration"}
              element={<GmatRegistrationPage />}
            />
            <Route
              path={"/exams/gmat/sample-question"}
              element={<GmatSampleQuesPage />}
            />
            <Route
              path={"/exams/gmat/syllabus"}
              element={<GmatSyllabusPage />}
            />

            {/*GRE*/}
            <Route
              path={"/exams/gre/registration"}
              element={<GRERegistrationPage />}
            />
            <Route
              path={"/exams/gre/syllabus"}
              element={<GRESyllabusPatternPage />}
            />
            <Route
              path={"/exams/gre/slot-booking"}
              element={<GRESlotBookingPage />}
            />
            <Route
              path={"/exams/gre/preparation"}
              element={<GREPreparationPage />}
            />
          </Route>
          {/* USA */}
          <Route
            path="/study-abroad/usa/universities/stanford-university"
            element={<StanfordUniversity />}
          />
          <Route
            path="/study-abroad/usa/universities/yale-university"
            element={<YaleUniversity />}
          />
          <Route
            path="/study-abroad/usa/universities/columbia-university"
            element={<ColumbiaUniversity />}
          />
          <Route path="/study-abroad/usa/universities/mit" element={<MIT />} />

          {/* UK */}
          <Route
            path="/study-abroad/uk/universities/oxford-university"
            element={<OxfordUniversity />}
          />
          <Route
            path="/study-abroad/uk/universities/cambridge-university"
            element={<CambridgeUniversity />}
          />
          <Route
            path="/study-abroad/uk/universities/manchester-university"
            element={<UniversityOfManchester />}
          />
          <Route
            path="/study-abroad/uk/universities/edinburgh-university"
            element={<UniversityOfEdinburgh />}
          />
          <Route
            path="/study-abroad/uk/universities/kings-college-london"
            element={<KingsCollegeLondon />}
          />
          <Route
            path="/study-abroad/uk/universities/imperial-college-london"
            element={<ImperialCollegeLondon />}
          />

          {/* Canada */}
          <Route
            path="/study-abroad/canada/universities/ubc"
            element={<UniversityOfBritishColumbia />}
          />
          <Route
            path="/study-abroad/canada/universities/mcgill-university"
            element={<McGillUniversity />}
          />
          <Route
            path="/study-abroad/canada/universities/university-of-alberta"
            element={<UniversityOfAlberta />}
          />
          <Route
            path="/study-abroad/canada/universities/university-of-montreal"
            element={<UniversityOfMontreal />}
          />
          <Route
            path="/study-abroad/canada/universities/university-of-ottawa"
            element={<UniversityOfOttawa />}
          />
          <Route
            path="/study-abroad/canada/universities/university-of-toronto"
            element={<UniversityOfToronto />}
          />

          {/* Australia */}
          <Route
            path="/study-abroad/australia/universities/macquarie-university"
            element={<MaccuireUniversity />}
          />
          <Route
            path="/study-abroad/australia/universities/monash-university"
            element={<MonashUniversity />}
          />
          <Route
            path="/study-abroad/australia/universities/university-of-sydney"
            element={<SydneyUniversity />}
          />
          <Route
            path="/study-abroad/australia/universities/university-of-melbourne"
            element={<MelboureUniversity />}
          />
          <Route
            path="/study-abroad/australia/universities/uq"
