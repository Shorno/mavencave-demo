...
const syllabusData = {
    ...
    sections: [
        ...
        { section: "Adaptive Test", time: "৪৫ মিনিট", description: "আপনার পারফরম্যান্স অনুযায়ী প্রশ্নগুলোর কঠোরতার স্তর পরিবর্তিত হবে" },
        { section: "Writing & Speaking", time: "১০ মিনিট", description: "কম্পিউটার এর ওপর ভিত্তি করে দেওয়া প্রশ্ন" },
    ]
};

const faqData = [
    { id: 1, question: "ডুয়োলিঙ্গো কি IELTS-এর চেয়ে সস্তা?", answer: "হ্যাঁ, ডুয়োলিঙ্গো ইংলিশ টেস্ট (DET) সাধারণত IELTS বা TOEFL-এর চেয়ে উল্লেখযোগ্যভাবে সস্তা। DET ফি প্রায় $৭০।" },
    { id: 2, question: "ডুয়োলিঙ্গো পরীক্ষার তারিখ পুনঃনির্ধারণ করা যায় কি?", answer: "পরীক্ষার তারিখের ২৮ দিন আগে পর্যন্ত কোনো অতিরিক্ত খরচ ছাড়াই পুনঃনির্ধারণ করা যায়। তবে, ২৮ দিনের সময়সীমা মিস হলে আপনাকে পুনরায় রেজিস্ট্রেশন করতে হবে।" },
    { id: 3, question: "পরীক্ষার ঠিক আগে কি আমি DET-এর স্লট বুক করতে পারি?", answer: "হ্যাঁ, ডুয়োলিঙ্গো ইংলিশ টেস্টের জন্য আপনি নির্ধারিত পরীক্ষার তারিখের ২৪ ঘণ্টা আগে পর্যন্ত রেজিস্ট্রেশন করতে পারেন, এর কোনো অতিরিক্ত লেট রেজিস্ট্রেশন ফি দিতে হয় না।" },
    { id: 4, question: "কোন কোন দেশ ডুয়োলিঙ্গো গ্রহণ করে?", answer: "TOEFL এবং IELTS-এর পাশাপাশি, ডুয়োলিঙ্গো ইংলিশ টেস্ট ৫,০০০+ প্রতিষ্ঠান দ্বারা স্বীকৃত, যা বিশ্বের বিভিন্ন দেশে মান্য, যেমন- যুক্তরাজ্য, নিউজিল্যান্ড, অস্ট্রেলিয়া এবং কানাডা।" },
    { id: 5, question: "ডুয়োলিঙ্গো ইংলিশ টেস্ট ফি কিভাবে প্রদান করা যায়?", answer: "ক্রেডিট কার্ড এবং ডেবিট কার্ডের মাধ্যমে পেমেন্ট করা যায়। DET নগদ বা তৃতীয় পক্ষের ওয়ালেট গ্রহণ করে না।" },
    { id: 6, question: "ডুয়োলিঙ্গো ইংলিশ টেস্ট কতবার নেওয়া যায়?", answer: "আপনি প্রতি ৩০ দিনে সর্বোচ্চ দুইবার DET পরীক্ষা দিতে পারেন (যার মধ্যে বাতিল বা স্কোর না হওয়া পরীক্ষাও অন্তর্ভুক্ত)।" },
    { id: 7, question: "ডুয়োলিঙ্গো টেস্টের জন্য কীভাবে প্রস্তুতি নেবেন?", answer: "প্রস্তুতি শুরু করার জন্য প্রথমে অফিশিয়াল ফ্রি প্রাকটিস টেস্ট দিন। প্রাপ্ত স্কোরের ওপর ভিত্তি করে আপনার দুর্বলতা চিহ্নিত করুন এবং Speaking বা Writing-এর মতো দুর্বল সেকশনগুলিতে বেশি সময় দিন।" },
    { id: 8, question: "ডুয়োলিঙ্গো-এর পূর্ণ স্কোর কত?", answer: "DET-এর পূর্ণ স্কোর হলো ১৬০। একটি DET স্কোর ১২০ প্রায় IELTS ব্যান্ড স্কোর ৬.৫-এর সমতুল্য।" },
    { id: 9, question: "কি আমি ভিসা আবেদন করার জন্য ডুয়োলিঙ্গো ইংলিশ টেস্ট ব্যবহার করতে পারি?", answer: "হ্যাঁ, বিশ্বজুড়ে হাজারো বিশ্ববিদ্যালয় এবং কিছু ভিসা কর্তৃপক্ষ DET স্কোর গ্রহণ করে।" },
];
...
const DuolingoGuide = () => {
    return (
        ...
        <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed">
          ডুয়োলিঙ্গো ইংলিশ টেস্ট (DET) কয়েকটি নতুন আপডেট ঘোষণা করেছে। নিচে এই আপডেটগুলোর টাইমলাইন দেওয়া হলো:
        </p>
            ...
            <li key={index} className="flex flex-col md:flex-row items-start text-gray-700">
              ...
              <div className="flex-1">
                ...
                <section className={SectionBox}>
                    ...
                    <p className="text-gray-700 mb-3">ডুয়োলিঙ্গো ইংলিশ টেস্ট ফি প্রদানের জন্য আপনার কাছে দুটি সুবিধাজনক পেমেন্ট অপশন রয়েছে: ক্রেডিট কার্ড এবং ডেবিট কার্ড।</p>
                    <ul className={ListStyle}>
                ...
                <section className={SectionBox}>
                    ...
                    <p className="text-gray-700 mb-3">
                        যদিও DET হলো সবচেয়ে সাশ্রয়ী মূল্যের ইংরেজি দক্ষতা পরীক্ষা, IELTS বা TOEFL-এর তুলনায়, তবুও আপনি পরীক্ষা ফি মুক্তির (fee waiver) সুযোগ পেতে পারেন।
                        প্রতিবছর, ডুয়োলিঙ্গো ইংলিশ টেস্ট এর **Access Program** এর মাধ্যমে সর্বোচ্চ ১০,০০০ শিক্ষার্থীকে ফি মুক্তি দেওয়া হয়।
                    </p>
                    ...
                    <ul className={ListStyle}>
                        ...
                        <li>পরিবর্তে, আপনাকে আপনার **কাউন্সেলর বা বিশ্ববিদ্যালয় পার্টনারের** এর সঙ্গে যোগাযোগ করতে হবে।</li>
                        <li>তারা ডুয়োলিঙ্গো ইংলিশ টেস্ট Access Program portal ব্যবহার করে আপনার পক্ষ থেকে waiver অনুরোধ করতে পারবেন।</li>
                    </ul>
                </section>
                ...
                <section className={SectionBox}>
                    ...
                    <ul className={ListStyle}>
                        ...
                        <li>কোনো বয়স বা শিক্ষাগত যোগ্যতার সীমাবদ্ধতা নেই। যদি আপনার বয়স ১৮ বছরের কম হয়, তবে আপনাকে পিতামাতা/অভিভাবকের অনুমতিপত্র জমা দিতে হবে।</li>
                    </ul>
                </section>

                {/* 6. Registration Process (Screenshot 202747) */}
                <section className={SectionBox}>
                    <h2 className={SectionHeader}>৭. ডুয়োলিঙ্গো ইংলিশ টেস্ট রেজিস্ট্রেশন: কীভাবে DET-তে নিবন্ধন করবেন?</h2>
                    <p className="text-gray-700 mb-3">
                        DET-এর রেজিস্ট্রেশন প্রক্রিয়া খুবই সহজ। ডুয়োলিঙ্গো ইংলিশ টেস্ট-এর জন্য রেজিস্ট্রেশন করতে আপনাকে শুধু অফিশিয়াল ওয়েবসাইটে যেতে হবে।
                    </p>
                ...
                <section className={SectionBox}>
                    ...
                    <p className="text-gray-700 mb-3">
                        ডুয়োলিঙ্গো ইংলিশ টেস্ট হলো প্রায় **এক ঘণ্টার পরীক্ষা** যা আপনাকে চারটি দক্ষতা মূল্যায়ন করবে: Reading, Writing, Listening, এবং Speaking! এটি একটি **অ্যাডাপ্টিভ টেস্ট**, যার মানে হলো আপনার পারফরম্যান্স অনুযায়ী প্রশ্নগুলোর কঠোরতার স্তর রিয়েল-টাইমে পরিবর্তিত হবে।
                    </p>
                ...
                <section className={SectionBox}>
                    ...
                    <p className="text-gray-700 mb-3">
                        আপনার DET প্রস্তুতি যারা শুরু করার জন্য, পরীক্ষার ফরম্যাট বোঝা গুরুত্বপূর্ণ কারণ DET-তে অ্যাডাপ্টিভ (adaptive) এবং গ্রেডেড (graded) প্রশ্নের একটি সংমিশ্রণ রয়েছে, যা আপনার রিডিং, রাইটিং, স্পিকিং, এবং লিসেনিং স্কিল মূল্যায়ন করে।
                    </p>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-2 text-sm md:text-base">
                        <li>প্রস্তুতি শুরু করার জন্য প্রথমে **অফিশিয়াল ফ্রি প্রাকটিস টেস্ট** দিন, যাতে আপনার বর্তমান দক্ষতার স্তর মূল্যায়ন করা যায়। এটি আপনার শক্তি ও দুর্বলতা সনাক্ত করতে সাহায্য করবে।</li>
                        <li>প্রাকটিস টেস্ট থেকে স্কোর পাওয়ার পর, আপনার DET স্কোর মূল্যায়ন করুন এবং কোন অংশে উন্নতি দরকার তা চিহ্নিত করুন। যেখানে আপনার পারফরম্যান্স দুর্বল, সেই সেকশনে বেশি ফোকাস দিন।</li>
                        <li>একটি DET স্কোর **১২০** প্রায় IELTS ব্যান্ড স্কোর **৬.৫-এর** সমান। আপনার স্কিল উন্নয়নের জন্য IELTS প্রস্তুতির উপকরণ ব্যবহার করাও উপকারী হতে পারে।</li>
                    </ul>
                </section>
                ...
                <section className={SectionBox}>
                    ...
                    <ul className={ListStyle}>
                        <li>ইংরেজিতে নিয়মিত যোগাযোগ করুন: বন্ধু বা পরিবারের সঙ্গে ইংরেজিতে কথা বলুন, এবং তাদের আপনার ভুলগুলো সংশোধন করতে বলুন।</li>
                        <li>আপনার বক্তব্য রেকর্ড ও রিভিউ করুন: নিজেকে কথা বলতে রেকর্ড করুন, তারপর ত্রুটির জন্য জায়গাগুলো চিহ্নিত করুন।</li>
                        <li>উচ্চারণ ও ফ্লুয়েন্সিতে ফোকাস করুন: আপনার উচ্চারণের দিকে মন দিন, কথোপকথনে ড্রপ রাখুন, এবং নিশ্চিত করুন যে আপনার ভাষা সুসংগত।</li>
                    </ul>

                    {/* Writing */}
                    <h3 className={SubSectionHeader}>Writing সেকশন:</h3>
                    <ul className={ListStyle}>
                        <li>নিয়মিত প্রাকটিস করুন: নিয়মিত প্রবন্ধ, ছোট আর্টিকেল বা অন্যান্য কনটেন্ট লিখুন, যা আপনার লিখন দক্ষতা উন্নত করবে এবং ভাষার ভান্ডার বাড়াবে।</li>
                        <li>অনলাইন কমিউনিটিতে লিখুন: Reddit বা Quora-র মত প্ল্যাটফর্মে বিভিন্ন আলোচনায় অংশ নিন।</li>
                        <li>গুণগত Writing বিশ্লেষণ করুন: আপনার প্রিয় ব্লগ বা প্রবন্ধগুলো অধ্যয়ন করুন, যাতে কার্যকর লিখন কৌশল বোঝা যায়।</li>
                    </ul>

                    {/* Reading */}
                    <h3 className={SubSectionHeader}>Reading সেকশন:</h3>
                    <ul className={ListStyle}>
                        <li>মূল ধারণা এবং বিশদে মনোযোগ দিন: মূল পয়েন্ট ও সাপোর্টিং ডিটেইলস চিহ্নিত করুন, যা আপনার comprehension দক্ষতা বাড়াতে সাহায্য করবে।</li>
                        <li>নিয়মিত ভোকাবুলারি শিখুন: নিয়মিত অজানা শব্দের চর্চা করুন।</li>
                        <li>ইংরাজিতে খবর অনুসরণ করুন: সাম্প্রতিক ঘটনা সম্পর্কে আপডেটেড থাকুন যাতে বিভিন্ন ধরনের টেক্সট পড়ার অভ্যাস হয় এবং নতুন শব্দ শেখা যায়।</li>
                    </ul>

                    {/* Listening */}
                    <h3 className={SubSectionHeader}>Listening সেকশন:</h3>
                    <ul className={ListStyle}>
                        <li>ইংরেজি মুভি বা সিনেমা দেখুন: এটি আপনাকে প্রাকৃতিক ভাষার উচ্চারণ এবং expressions-এর সঙ্গে পরিচিত করাবে।</li>
                        <li>পডকাস্ট এবং গান শুনুন: একই কনটেন্ট বারবার শোনা vocabulary এবং comprehension বৃদ্ধিতে সাহায্য করে।</li>
                        <li>সাবটাইটেল ব্যবহার করুন: আপনার মাতৃভাষায় সিনেমা বা শো দেখুন, সঙ্গে English সাবটাইটেল ব্যবহার করুন। এটি আপনার native language এবং English-এর মধ্যে সেতুবন্ধন তৈরি করে।</li>
                    </ul>
                </section>
                ...
                <section className={SectionBox}>
                    ...
                    <p className="text-gray-700 mb-3">
                        সাফল্যের জন্য **ধারাবাহিকতা** সবচেয়ে গুরুত্বপূর্ণ। প্রতিদিন **৩০-৩০ মিনিট** মনোযোগী ইংরেজি অনুশীলন করার লক্ষ্য রাখুন। যেহেতু ডুয়োলিঙ্গো ইংলিশ টেস্ট adaptive format অনুসরণ করে, তাই আপনার অনুশীলন সেখানে বিভিন্ন ধরনের প্রশ্ন অন্তর্ভুক্ত করুন।
                    </p>
                    ...
                    <ul className={ListStyle}>
                        ...
                        <li>নিয়মিত প্রাকটিস টেস্ট নেওয়ার মাধ্যমে আপনি আপনার প্রস্তুতি মূল্যায়ন করতে পারবেন এবং বুঝতে পারবেন কোন সেকশনগুলোতে আরও উন্নতি প্রয়োজন।</li>
                        <li>**Official DET Website:** DET-এর অফিশিয়াল ওয়েবসাইটে অসীম প্রাকটিস টেস্ট এবং অফিশিয়াল গাইডস পাওয়া যায়।</li>
                    </ul>
                </section>
                ...
                <section className='mt-8 text-center text-gray-500 text-sm pb-4'>
                    ...
                    <p className='text-base text-gray-700'>
                        এই কৌশলগুলো দৈনন্দিন রুটিনে অন্তর্ভুক্ত করলে আপনার দক্ষতা বৃদ্ধি পাবে এবং ডুয়োলিঙ্গো ইংলিশ টেস্টের জন্য কার্যকরভাবে প্রস্তুতি নেওয়া সম্ভব হবে।
                    </p>
                </section>
            </div>
        </div>
