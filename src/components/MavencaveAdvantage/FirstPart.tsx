    ...
    <div className="bg-white min-h-screen p-4 sm:p-8 font-sans antialiased text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-[#4446a8] mb-4">
          Mavencave সুবিধা কীভাবে কাজ করে?
        </h2>
        <p className="text-gray-600 text-sm md:text-base mb-8 max-w-3xl mx-auto">
          Mavencave Advantage আপনাকে দেয় ব্যক্তিগত নির্দেশনা, বিশেষজ্ঞ পরামর্শ এবং বাছাইকৃত রিসোর্স, যা আপনাকে IELTS এবং PTE সহ সকল পরীক্ষায় উচ্চতর স্কোর সহায়তা করে এবং এতে গ্রামাটিক ত্রুটি, ফিডব্যাক এবং স্ট্রাটেজি লেখা, যা আপনার দক্ষতা ও আত্মবিশ্বাস দ্রুত বাড়াতে সাহায্য করবে।
        </p>
