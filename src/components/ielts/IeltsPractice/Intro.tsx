  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto my-8">
      ...
      <p className="text-gray-700 mb-4">
       IELTS পরীক্ষার প্রস্তুতি নিচ্ছেন? আমাদের ব্যাপক IELTS প্র্যাকটিস টেস্টগুলো আপনাকে আপনার টার্গেট ব্যান্ড স্কোর অর্জন সাহায্য করার জন্য ডিজাইন করা হয়েছে।
      </p>
      <p className="text-gray-700 mb-4">
      প্র্যাকটিস টেস্টগুলো খুবই গুরুত্বপূর্ণ কারণ এগুলো আপনাকে IELTS পরীক্ষার ফরম্যাটের সাথে পরিচিত হতে, সময় ব্যবস্থাপনা দক্ষ করতে তোলে, এবং যেসব বিষয়গুলোতে উন্নতির প্রয়োজন তা চিহ্নিত করতে সাহায্য করে।
      </p>
      <p className="text-gray-700">
       বাস্তব পরীক্ষার পরিবেশে অনুশীলন করার মাধ্যমে আপনি আত্মবিশ্বাস অর্জন করবেন এবং আপনার শোনার, পড়ার, লেখার ও বলার দক্ষতা উন্নত করবেন, যাতে পরীক্ষার দিন আপনি সম্পূর্ণ প্রস্তুত থাকেন।


      </p>
      <p className="text-gray-700 mt-4">
       আজই আমাদের প্র্যাকটিস টেস্ট দিয়ে আপনার IELTS প্রস্তুতি শুরু করুন এবং সফলতার প্রথম পদক্ষেপ নিন।
      </p>
    </div>
  );
};
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto my-8">
      ...
      <p className="text-gray-700 mb-2">
        ...
        কখনও ডায়াগ্রাম বা গ্রাফসহ ।এই লেখাগুলোর উৎস হিসেবে জার্নাল, আর্টিকেল এবং সংবাদপত্র থেকে নেওয়া হয়।
      </p>
      <p className="text-gray-700 mb-4">
        ...
        আগ্রহের বিষয় নিয়ে লেখা প্যাসেজ পড়বেন, যা ডকুমেন্ট,হ্যান্ডবুক বা বিজ্ঞাপন হতে পারে।
      </p>
      <p className="text-gray-700 mb-4">
    ...
    <div className="flex flex-col items-center p-8 bg-white rounded-lg shadow-md max-w-4xl mx-auto my-8">
      ...
      <div className="w-full p-6 bg-gray-50 rounded-lg">
        ...
        <div className="text-lg text-gray-700 space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 pl-4">
            <li>Task 1-এ আপনাকে একটি টেবিল, গ্রাফ, চার্ট, বা ডায়াগ্রাম কমপক্ষে ১৫০ শব্দে বর্ণনা করতে হবে।

</li>
            <li>Task 2-এ একটি রচনা (essay) লিখতে হবে, যার দৈর্ঘ্য ন্যূনতম ২৫০ শব্দ। উভয় টাস্কই লিখনীর স্টাইল একাডেমিক বা নিরপেক্ষ হতে হবে।</li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-2 pl-4">
            ...
            <li>Task 2-এ একটি রচনা লিখতে হবে, যার দৈর্ঘ্য ন্যূনতম ২৫০ শব্দ। এখানে লেখার ধরন আধা-আधिकारिक (semi-formal) বা আনুষ্ঠানিক (formal) হতে পারে, টাস্ক অনুযায়ী।</li>
          </ul>
        </div>

        <div className="mt-6 flex flex-col items-center">
          <h3 className="text-xl font-semibold mb-2 text-gray-900">লিখনীর নমুনা প্রশ্নসমূহ:</h3>
          <p className="text-lg text-gray-700">
            ১. মানুষের একটি অংশ বিশ্বাস করে যে অপরাধ্মূলক আচরণের মূল কারণ হলো জিন। অন্যরা মনে করে পরিবেশগত পরিস্থিতিই মানুষকে অপরাধে প্রচলিত করে। উভয় দিকের ব্যাপারে আপনার চিন্তা প্রকাশ করুন এবং আপনার মতামত দিন।
          </p>
          <p className="text-lg text-gray-700 mt-4">
           ২.নিচে বণিত ডায়াগ্রামে প্লাস্টিক এবং কাচেরপাত্র পুনব্যবহারের তথ্য দেওয়া আছে। মূল তথ্যগুলো নির্বাচন করে তার সংক্ষিপ্তসার দিন এবং প্রাসংগিক তুলনা উপস্থাপন করুন।
          </p>
      ...
      <div className="w-full mt-8">
        <button className="w-full py-4 px-6 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition duration-300">
          IELTS রাইটিং প্র্যাকটিস টেস্টের জন্য এখানে ক্লিক করুন →
        </button>
      </div>
    </div>
  );
