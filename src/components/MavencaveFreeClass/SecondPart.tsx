  ...
  const faqItems = [
    {
      ...
      answer:
        "অনলাইনে প্রস্তুতি নিতে Mavencave এর মতো প্ল্যাটফর্ম বেছে নিতে পারেন, যা আপনাকে লাইভ ক্লাস, মক টেস্ট এবং বিশেষজ্ঞ প্রশিক্ষকের মাধ্যমে সহায়তা করবে।",
    },
    {
