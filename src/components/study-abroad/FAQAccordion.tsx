    ...
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">বেশিরভাগ বিশ্ববিদ্যালয় ক্যাম্পাসে ২৪/৭ নিরাপত্তা সেবা এবং শিক্ষার্থী সহায়তা প্রদান করে।</p>
            </div>
        )
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                <p>বাংলাদেশি শিক্ষার্থীদের মধ্যে যুক্তরাষ্ট্রে পড়াশোনার আগ্রহের পেছনে বেশ কয়েকটি গুরুত্বপূর্ণ কারণ রয়েছে:</p>
                <div className="space-y-3">
                    <div className="flex items-start gap-3">
                        <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5">১</span>
                        <div>
                            <h4 className="font-semibold">বিশ্বমানের শিক্ষা</h4>
                            <p className="text-sm text-muted-foreground">QS র‍্যাংকিংয়ে শীর্ষ বিশ্ববিদ্যালয় এবং উন্নত গবেষণা সুবিধা</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5">২</span>
                        <div>
                            <h4 className="font-semibold">ক্যারিয়ারের সুযোগ</h4>
                            <p className="text-sm text-muted-foreground">আন্তর্জাতিক কর্মক্ষেত্রে প্রবেশ এবং উচ্চ বেতনের চাকরি</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5">৩</span>
                        <div>
                            <h4 className="font-semibold">সাংস্কৃতিক বৈচিত্র্য</h4>
                            <p className="text-sm text-muted-foreground">বিশ্বব্যাপী নেটওয়ার্ক গড়ার এবং আন্তর্জাতিক অভিজ্ঞতা অর্জনের সুযোগ</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5">৪</span>
                        <div>
                            <h4 className="font-semibold">স্কলারশিপ সুবিধা</h4>
                            <p className="text-sm text-muted-foreground">মেধাভিত্তিক এবং প্রয়োজনভিত্তিক আর্থিক সহায়তার ব্যাপক সুযোগ</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    },
    {
        ...
        answer: (
            <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm"><strong>গুরুত্বপূর্ণ:</strong> ভিসা ইন্টারভিউয়ের সময় দেশে ফিরে আসার ইচ্ছার প্রমাণ এবং পড়াশোনা শেষে কী করবেন তার স্পষ্ট পরিকল্পনা থাকতে হবে।</p>
                </div>
            </div>
        )
    }
...
export default function FAQAccordion() {
    return (
        <div className="w-full max-w-4xl mx-auto">
            <h2 className="text-3xl font-semibold mb-8 text-center">বেশি জিজ্ঞাসিত প্রশ্ন</h2>
